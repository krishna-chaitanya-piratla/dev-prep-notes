...
import { MainNavigationWrapper, IconContainer, LinkItem, ExpandIcon, LinkText, NoPagesPlaceholder, MainNavigationHeader, NavigationLogo } from '../../styles/MainNavigation/MainNavigation';
    ...
    return (
      <React.Fragment key={page.metadata.link}>
        ...
        >
          ...
          {logo && <NavigationLogo>{logo}</NavigationLogo>} {/* Use NavigationLogo component */}
